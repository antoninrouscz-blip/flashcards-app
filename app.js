...
const SEED_CARDS = [
  ...
  ['to rent', 'pronajmout'],
  // Misc
  ['darling / sweetheart', 'miláček'],
  ['terribly / awfully', 'strašně'],
  ['to prepare', 'připravovat'],
  ['to prepare', 'připravit'],
  ['lecture', 'přednáška'],
  ['to host / to moderate', 'moderovat'],
  ['director', 'ředitel'],
  ['embassy', 'ambasáda'],
  ['hopefully / perhaps', 'snad'],
  ...
  ['betrayal', 'zrada'],
  ['revenge', 'pomsta'],
  // Norse mythology - magic
  ['curse', 'kletba'],
  ['magic / spell', 'kouzlo'],
  ['prophecy', 'proroctví'],
  ['sacrifice', 'oběť'],
  ['temple', 'chrám'],
  // Norse mythology - creatures & phenomena
  ['serpent / snake', 'had'],
  ['dragon', 'drak'],
  ['wolf', 'vlk'],
  ['raven', 'havran'],
